    ...
    public void testCollect() {
        ...
        Assert.assertArrayEquals(
                new FieldStats[] {
                    ...
                    new FieldStats(
                            StringData.fromString("Flink"), StringData.fromString("Flink"), 0),
        ...
        Assert.assertArrayEquals(
                new FieldStats[] {
                    ...
                    new FieldStats(
                            StringData.fromString("Flink"), StringData.fromString("Flink"), 1),
                    new FieldStats(null, null, 0)
                },
                collector.extract());
        ...
        Assert.assertArrayEquals(
                new FieldStats[] {
                    ...
                    new FieldStats(
                            StringData.fromString("Apache"), StringData.fromString("Flink"), 1),
                    new FieldStats(null, null, 0)
                },
                collector.extract());
