...
import org.apache.flink.table.storage.filestore.utils.ObjectSerializerTestBase;
...
public class SstFileMetaSerializerTest extends ObjectSerializerTestBase<SstFileMeta> {
    ...
    public SstFileMetaSerializerTest() {
        this.gen = new SstTestDataGenerator();
    }

    @Override
    protected SstFileMetaSerializer serializer() {
        return new SstFileMetaSerializer(
                TestKeyValueGenerator.ROW_TYPE, TestKeyValueGenerator.KEY_TYPE);
    }
