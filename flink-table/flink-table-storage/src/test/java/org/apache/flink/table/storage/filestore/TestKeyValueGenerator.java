...
public class TestKeyValueGenerator {
    ...
    public static final RowType PARTITION_TYPE =
            RowType.of(new VarCharType(false, 8), new IntType(false));
    public static final RowType KEY_TYPE = RowType.of(new IntType(false), new BigIntType(false));

    private static final RowDataSerializer ROW_SERIALIZER = new RowDataSerializer(ROW_TYPE);
    ...
    private static final RecordComparator KEY_COMPARATOR =
            (a, b) -> {
                ...
                long secondResult = a.getLong(1) - b.getLong(1);
                if (secondResult > 0) {
                    return 1;
