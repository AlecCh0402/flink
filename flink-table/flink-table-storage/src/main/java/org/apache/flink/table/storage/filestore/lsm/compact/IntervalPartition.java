...
package org.apache.flink.table.storage.filestore.lsm.compact;

import org.apache.flink.table.data.binary.BinaryRowData;
import org.apache.flink.table.runtime.generated.RecordComparator;
import org.apache.flink.table.storage.filestore.lsm.SortedRun;
...
public class IntervalPartition {
    ...
    public IntervalPartition(List<SstFileMeta> inputFiles, RecordComparator keyComparator) {
    ...
    private List<SortedRun> partition(List<SstFileMeta> metas) {
        ...
        return queue.stream().map(SortedRun::new).collect(Collectors.toList());
    }
}
