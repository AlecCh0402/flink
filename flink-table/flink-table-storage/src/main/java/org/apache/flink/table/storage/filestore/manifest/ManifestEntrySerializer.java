...
import org.apache.flink.table.storage.filestore.lsm.sst.SstFileMetaSerializer;
...
public class ManifestEntrySerializer extends ObjectSerializer<ManifestEntry> {
    ...
    public ManifestEntrySerializer(RowType partitionType, RowType rowType, RowType keyType) {
        super(ManifestEntry.schema(partitionType, rowType, keyType));
        this.partitionSerializer = new RowDataSerializer(partitionType);
        this.sstFileMetaSerializer = new SstFileMetaSerializer(rowType, keyType);
    }
