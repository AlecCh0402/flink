 ...
 * org.apache.flink.table.planner.plan.rules.logical.SplitAggregateRule} can be applied once {@link
 * OptimizerConfigOptions#TABLE_OPTIMIZER_DISTINCT_AGG_SPLIT_ENABLED} is enabled.
 */
@Experimental
            ...
            rel.accept(
                    new RelShuttleImpl() {
                        ...
                        public RelNode visit(RelNode other) {
                            if (other instanceof StreamPhysicalGroupAggregateBase) {
                                if (matches((StreamPhysicalGroupAggregateBase) other)) {
